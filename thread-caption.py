...
def process_image(image_path, model_type):
    ...
    if model_type == 'gpt':
        ...
        openai_api(image_path, prompt, API_KEY_GPT, API_URL_GPT, quality="low", model="gpt-4o-2024-05-13")
    else:
        claude_api(image_path, prompt, API_KEY_CLAUDE, API_URL_CLAUDE, quality="low", model="claude-3-5-sonnet-20240620")
